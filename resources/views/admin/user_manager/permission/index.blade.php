      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="crud-title">Tambah Permission</h5>
...
@section('script')
  ...
  <script>      
    function insertData() {
      ...
      $('#crud-title').html('Tambah Permission');
      $('#crud').attr('action', '');
    ...
    function updateData(id) {
      ...
      $('#crud-title').html('Ubah Permission');
      $('#crud').attr('action', `{{ url('admin/user-manager/permission/${id}') }}`);
      
      $.ajax({
        url: `{{ url('admin/user-manager/permission/data/${id}') }}`,
        complete: function() {
    ...
    function deleteData(id) {
      $('#delete-form').attr('action', `{{ url('admin/user-manager/permission/${id}') }}`);
    }
  </script>
@endsection