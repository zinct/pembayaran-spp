      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="crud-title">Tambah Tahun Ajaran</h5>
...
@section('script')
  ...
  <script>      
    function insertData() {
      ...
      $('#crud-title').html('Tambah Tahun Ajaran');
      $('#crud').attr('action', '');
    ...
    function updateData(id) {
      ...
      $('#crud-title').html('Ubah Tahun Ajaran');
      $('#crud').attr('action', `{{ url('admin/data/tahun/${id}') }}`);
      
      $.ajax({
        url: `{{ url('admin/data/tahun/data/${id}') }}`,
        complete: function() {
    ...
    function deleteData(id) {
      $('#delete-form').attr('action', `{{ url('admin/data/tahun/${id}') }}`);
    }
  </script>
@endsection